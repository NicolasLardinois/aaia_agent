...
Die Makroanalyse umfasst dabei unter anderem den **Buffett-Indikator** (Verhältnis von Gesamtmarktkapitalisierung zu BIP) als Bewertungsmassstab für den gesamten Aktienmarkt sowie den **adjustierten Big Mac Index** als Indikator für Kaufkraftparität und Währungsbewertungen zwischen Ländern.
...
|---|---|
| `MacroChiefAgent` | BIP, Inflation (USA/EU/CH), Zinsen, Geldmenge, Arbeitsmarkt, Kredit, Shiller-CAPE |
...
| `SectorChiefAgent` | Sektor-Performance (USA/EU), Sektor-Rotation nach Regime |
...
**Für den Gesamtmarkt:**
- **Buffett-Indikator** (Total Market Cap / BIP): Zeigt an ob der Aktienmarkt als Ganzes über- oder unterbewertet ist — Warren Buffetts bevorzugter Massstab für die Marktbewertung
